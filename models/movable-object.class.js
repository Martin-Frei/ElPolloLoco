...
export class MovableObject {
  ...
  applyGravity() {
    ...
    console.log('✅ Gravity Interval gespeichert:', this.gravityInterval);
  }

  isAboveGround() {
    return this.y < 140; // Standard-Boden bei y=140
  }
}
